	...
	<div class="main-body">
		...
		<div class="privacy-page">
			...
			<div class="fashion-top">
			  <div class="fashion-left">
					<a href="single.jsp"><img src="images/f1.jpg" class="img-responsive" alt=""></a>
					<h3><a href="single.jsp">Contrary to popular belief</a></h3>
				</div>
				<div class="fashion-right">
					<a href="single.jsp"><img src="images/f2.jpg" class="img-responsive" alt=""></a>
					<h3><a href="single.jsp">Lorem Ipsum is simply</a></h3>
				</div>
				<div class="clearfix"></div>
			  </div>
			<div class="fashion-top">
			  <div class="fashion-left">
					<a href="single.jsp"><img src="images/f3.jpg" class="img-responsive" alt=""></a>
					<h3><a href="single.jsp">There are many variations</a></h3>
				</div>
				<div class="fashion-right">
					<a href="single.jsp"><img src="images/f4.jpg" class="img-responsive" alt=""></a>
					<h3><a href="single.jsp">Sed ut perspiciatis</a></h3>
				</div>
				<div class="clearfix"></div>
			  </div>
			<div class="fashion-top">
			  <div class="fashion-left">
					<a href="single.jsp"><img src="images/f5.jpg" class="img-responsive" alt=""></a>
					<h3><a href="single.jsp">denouncing pleasure</a></h3>
				</div>
				<div class="fashion-right">
					<a href="single.jsp"><img src="images/f6.jpg" class="img-responsive" alt=""></a>
					<h3><a href="single.jsp">At vero eos et accusamus</a></h3>
				</div>
				<div class="clearfix"></div>
			  </div>
			<div class="fashion-top">
			  <div class="fashion-left">
					<a href="single.jsp"><img src="images/f7.jpg" class="img-responsive" alt=""></a>
					<h3><a href="single.jsp">On the other hand</a></h3>
				</div>
				<div class="fashion-right">
					<a href="single.jsp"><img src="images/f8.jpg" class="img-responsive" alt=""></a>
					<h3><a href="single.jsp">blanditiis praesentium</a></h3>
				</div>
				<div class="clearfix"></div>
			  </div>
			</div>
					...
					<header>
					 ...
					 <div class="course_demo1">
								  <ul id="flexiselDemo">
									 ...
									 <li>
										<a href="single.jsp"><img src="images/f8.jpg" alt="" /></a>
									 </li>
									 <li>
					 ...
					 <div class="course_demo1">
								  <ul id="flexiselDemo1">
									 ...
									 <li>
										<a href="single.jsp"><img src="images/f7.jpg" alt="" /></a>
									 </li>
									 <li>
		...
		<!-- 	<div class="first_half">
				<div class="categories">
					<header>
						<h3 class="side-title-head">类别</h3>
					</header>
					<ul>
						<li><a href="business.jsp">财经</a></li>
		...
		<div class="footer-bottom">
			<div class="wrap">
				<div class="copyrights col-md-6">
					<p>Copyright &copy; 2016.Company name All rights reserved.</p><!-- <a target="_blank" href="http://www.cssmoban.com/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></p> -->
				</div>
